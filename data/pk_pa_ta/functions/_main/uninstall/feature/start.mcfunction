#> pk_pa_ta:_main/uninstall/feature/start
#
# @input args
...
execute if score $uninstall.list.length pk.temp matches 0 unless data storage pk:common uninstall.feature_args{callback:""} run function pk_pa_ta:_main/uninstall/callback with storage pk:common uninstall.feature_args
