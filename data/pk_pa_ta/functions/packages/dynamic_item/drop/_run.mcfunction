#> pk_pa_ta:packages/dynamic_item/drop/_run
#
...
execute if data storage pk:common package.dynamic_item.args{apply_random_motion:1b} run function pk_pa_ta:packages/dynamic_item/drop/apply_random_motion
...
# Summon item
function pk_pa_ta:packages/dynamic_item/drop/summon_item with storage pk:common package.dynamic_item.args
