...
execute if items entity @s container.* player_head[custom_data~{pk_data:{id:"painting_table",from:"painting_table"}},!custom_data~{pk_data:{version:30001s}}] run function pk_pa_ta:items/painting_table/update/run {version:30001s}
