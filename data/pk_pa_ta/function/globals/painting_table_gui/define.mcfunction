...
data modify storage pk:pa_ta database.globals.painting_table_gui append value {id:"minecraft:player_head",count:1,components:{"minecraft:tooltip_display":{hide_tooltip:true},"minecraft:bundle_contents":[{id:"minecraft:stick",count:64}],"minecraft:custom_data":{pk_data:{gui:1b,from:"painting_table",restore_gui_on_click:1b}},"minecraft:custom_model_data":{strings:["pk_pa_ta:gui_player_head_indicator"]}},Slot:7b}
