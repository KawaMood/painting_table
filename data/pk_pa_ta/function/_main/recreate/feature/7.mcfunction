...
# Logs
tellraw @a[tag=pk.recreate] [{text:"Recreated \"",color:"gray"},{nbt:"recreate.feature_args.feature_id",storage:"pk:common",interpret:true},{text:"\" at ["},{nbt:"recreate.feature_single.location.x",storage:"pk:common",interpret:true},{text:","},{nbt:"recreate.feature_single.location.y",storage:"pk:common",interpret:true},{text:","},{nbt:"recreate.feature_single.location.z",storage:"pk:common",interpret:true},{text:"] in "},{nbt:"recreate.feature_single.location.dimension",storage:"pk:common",interpret:true}]
