...
execute unless data storage pk:common installed_datapacks[{}] unless data storage pk.common:data Datapacks[{}] run function pk_pa_ta:_main/uninstall/references/common
